...
from text_process import term_tfidf, term_tf
...
print "Before term tf"

[data,features,ids_ret] = term_tf(ids, mapping, index, doctype, es)
...
scores = cross_validation.cross_val_score(clf, binary_data, labels_ret, cv=3)
